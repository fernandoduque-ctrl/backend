<#
.SYNOPSIS
    Mescla a branch dev na main e envia para origin (repositório backend — folha-solid-wizard-backend).
...
.EXAMPLE
    .\scripts\merge-dev-to-main.ps1 -RepoRoot "C:\projects\mvp\backend"
#>
param(
