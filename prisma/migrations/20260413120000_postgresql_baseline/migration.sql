...
CREATE TABLE "WizardStage" (
    ...
    CONSTRAINT "WizardStage_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "WizardStepProgress" (
    ...
    CONSTRAINT "WizardStepProgress_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "WorkScheduleWeekday" (
    ...
    CONSTRAINT "WorkScheduleWeekday_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "EmployeePaymentBank" (
    ...
    CONSTRAINT "EmployeePaymentBank_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PensionConfiguration" (
    ...
    CONSTRAINT "PensionConfiguration_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "HistoricalPayrollFile" (
    ...
    "uploadedFileId" TEXT NOT NULL,
    "userNote" TEXT,
    "totalEarnings" DECIMAL(65,30),
    "totalDeductions" DECIMAL(65,30),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "HistoricalPayrollFile_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "EmployeeRegistryFile" (
    ...
    CONSTRAINT "EmployeeRegistryFile_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "TaxReliefConfiguration" (
    ...
    CONSTRAINT "TaxReliefConfiguration_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "VacationRecord" (
    ...
    "accrualEndDate" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Benefit" (
    ...
    "companyPercentage" DECIMAL(65,30),
    "employeePercentage" DECIMAL(65,30),
    "hasDependents" BOOLEAN NOT NULL DEFAULT false,
    "dependentCompanyPercentage" DECIMAL(65,30),
    "dependentEmployeePercentage" DECIMAL(65,30),
    "valueType" TEXT NOT NULL,
    "defaultValue" DECIMAL(65,30),
    "transportDiscountPercent" DECIMAL(65,30),
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "BenefitSupplier" (
    ...
    CONSTRAINT "BenefitSupplier_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BenefitSupplierLayoutFile" (
    ...
    CONSTRAINT "BenefitSupplierLayoutFile_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ESocialImportBatch" (
    ...
    CONSTRAINT "ESocialImportBatch_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ESocialImportStageRecord" (
    ...
    CONSTRAINT "ESocialImportStageRecord_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ESocialImportAlert" (
    ...
    CONSTRAINT "ESocialImportAlert_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "CompanyLogo" ADD CONSTRAINT "CompanyLogo_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompanyLogo" ADD CONSTRAINT "CompanyLogo_uploadedFileId_fkey" FOREIGN KEY ("uploadedFileId") REFERENCES "UploadedFile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WizardStage" ADD CONSTRAINT "WizardStage_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WizardStepProgress" ADD CONSTRAINT "WizardStepProgress_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WorkScheduleWeekday" ADD CONSTRAINT "WorkScheduleWeekday_workScheduleId_fkey" FOREIGN KEY ("workScheduleId") REFERENCES "WorkSchedule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EmployeePaymentBank" ADD CONSTRAINT "EmployeePaymentBank_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EmployeePaymentBank" ADD CONSTRAINT "EmployeePaymentBank_bankReferenceId_fkey" FOREIGN KEY ("bankReferenceId") REFERENCES "BankReference"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PensionConfiguration" ADD CONSTRAINT "PensionConfiguration_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HistoricalPayrollFile" ADD CONSTRAINT "HistoricalPayrollFile_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HistoricalPayrollFile" ADD CONSTRAINT "HistoricalPayrollFile_uploadedFileId_fkey" FOREIGN KEY ("uploadedFileId") REFERENCES "UploadedFile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeaveRecord" ADD CONSTRAINT "LeaveRecord_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DependentRecord" ADD CONSTRAINT "DependentRecord_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EmployeeRegistryFile" ADD CONSTRAINT "EmployeeRegistryFile_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EmployeeRegistryFile" ADD CONSTRAINT "EmployeeRegistryFile_uploadedFileId_fkey" FOREIGN KEY ("uploadedFileId") REFERENCES "UploadedFile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TaxReliefConfiguration" ADD CONSTRAINT "TaxReliefConfiguration_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VacationRecord" ADD CONSTRAINT "VacationRecord_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Benefit" ADD CONSTRAINT "Benefit_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BenefitSupplier" ADD CONSTRAINT "BenefitSupplier_benefitId_fkey" FOREIGN KEY ("benefitId") REFERENCES "Benefit"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BenefitSupplierLayoutFile" ADD CONSTRAINT "BenefitSupplierLayoutFile_benefitSupplierId_fkey" FOREIGN KEY ("benefitSupplierId") REFERENCES "BenefitSupplier"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BenefitSupplierLayoutFile" ADD CONSTRAINT "BenefitSupplierLayoutFile_uploadedFileId_fkey" FOREIGN KEY ("uploadedFileId") REFERENCES "UploadedFile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayrollRubric" ADD CONSTRAINT "PayrollRubric_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayrollRubric" ADD CONSTRAINT "PayrollRubric_defaultCostCenterId_fkey" FOREIGN KEY ("defaultCostCenterId") REFERENCES "CostCenter"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayrollRubric" ADD CONSTRAINT "PayrollRubric_defaultDepartmentId_fkey" FOREIGN KEY ("defaultDepartmentId") REFERENCES "Department"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ESocialImportBatch" ADD CONSTRAINT "ESocialImportBatch_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ESocialImportBatch" ADD CONSTRAINT "ESocialImportBatch_requestedById_fkey" FOREIGN KEY ("requestedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ESocialImportStageRecord" ADD CONSTRAINT "ESocialImportStageRecord_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "ESocialImportBatch"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ESocialImportAlert" ADD CONSTRAINT "ESocialImportAlert_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "ESocialImportBatch"("id") ON DELETE CASCADE ON UPDATE CASCADE;
